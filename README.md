...
| **V** (volume series) | Born numbers *derived* (not transported) as Fubini-Study volumes: Stern-Gerlach, Malus, Bell, GHZ, Hardy, the trine / USD / SIC / qutrit / Hesse / MUB POVMs, and **any projective measurement context** (`context_born_frequency_volume` — the general contextuality / Kochen-Specker grounding, rank-1) | `Empirical/CSD/{SternGerlach,Malus,Bell,GHZ,Hardy,Trine,USD,SIC,…}Volume.lean`, `Empirical/CSD/ContextVolume.lean` |
