...
- **the finite-QM reconstruction targets** — the FND "Choice A" ledger (P1–P9 / B1–B7 / **T1–T16**): Born, unitary/Schrödinger dynamics, unique measurement outcome, general conditional + Lüders update, mixed states, POVMs, contextuality, Bell/CGLMP/Tsirelson (universal bounds), no-signalling, interference — each a `Prop` target inhabited by a proved theorem (`CsdLean4/FND/`, `AXIOMS.md §3.7`);
