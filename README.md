...
| Statistical mechanics | **Opened** — TH1 canonical typicality (expectation) + TH2 second law (H-theorem) + TH3 free energy (Gibbs variational principle) done; Landauer (TH-4) is next |
