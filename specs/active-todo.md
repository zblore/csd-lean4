...
| 5 | LF6 general-N entangled tier — C.1 DONE 2026-06-30 (GHZ forced-contextuality crux `no_product_partition_realises_ghz`, DETERMINISTIC all-or-nothing forcing via the existing GHZ no-go; GHZContextuality.lean). NEXT: C.2 (GHZ de-isolation FLOW, mirror A.2/A.3 at N=8) + wider general-N (bipartite d×d, GHZ_n) | LF6 | L | C.1 DONE; C.2+ open | |
