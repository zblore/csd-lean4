...
bounds (the *full* no-broadcasting is no longer on this list: `BACKLOG.md` row BC, 2026-09-13 —
the BCFJS `iff` is a theorem in `Mathlib/QuantumInfo/Broadcasting.lean`, proved without fidelity),
