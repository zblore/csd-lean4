...
| Sigma | `SigmaLayer/MeasurementConstraints.lean` | Pass | S0 | No-go statements expose measurability/measure-preservation and positive/null-set assumptions. The file avoids claiming witness existence. |
| Sigma | `SigmaLayer/SwapWitness.lean` | Pass with notes | S2 | Explicit involutive, measure-preserving relocation witness with composition law. It is engineered and piecewise rather than continuous; documentation states this. |
| Sigma | `SigmaLayer/SwapLuders.lean` | Needs domain validation | S3 | Pushforward calculation is coherent. Lüders state is supplied by the pre-calibrated bank slot; see F-05. |
| Sigma | `SigmaLayer/JoinProtocol.lean` | Pass with notes | S2 | Explicit degenerate-record protocol with strong measure bookkeeping. The architecture is specialized and large, but assumptions are visible. |
| Sigma | `SigmaLayer/JoinLuders.lean` | Needs domain validation | S3 | Nonzero-block conditioning and marginal calculation are substantive; the outcome-specific post-state is still implemented by calibrated relocation. |
| Sigma | `SigmaLayer/PointerProtocol.lean` | Pass with notes | S2 | Continuous smooth-ramp record protocol is a genuine alternative witness. Correlation is restricted to its stated sectors and is approximate in Born assignment. |
| Sigma | `SigmaLayer/PointerGeneration.lean` | Pass with notes | S3 | Correctly proves a fibrewise Schrödinger ODE for fixed weights. The base marginal is unchanged, so this is not a fully back-reacting joint Hamiltonian measurement flow. |
| Sigma | `SigmaLayer/PointerLuders.lean` | Pass with notes | S2 | Defines the record-triggered relocation layer. Measure preservation and marginal results live downstream, making this file an implementation brick rather than a closure. |
| Sigma | `SigmaLayer/PovmDynamics.lean` | Pass with notes | S3 | Naimark selector statistics and dilation-relative posts are coherent. The record dynamics starts at `[Vψ]`; it does not dynamically realize preparation of the dilation/ancilla state. |
| Sigma | `SigmaLayer/PovmSectorBorn.lean` | Pass with notes | S2 | Correctly lifts selector Born to the join protocol's outcome sector. It remains dilation-relative and begins from the already-dilated preparation, as documented. |
| Sigma | `SigmaLayer/MeasurementCapstone.lean` | Needs change | S3 | See F-06. It is an index of rank-one, rotated, degenerate and smooth witnesses, not one measurement model satisfying every field. It is also omitted from the default package root. |
...
| `SigmaLayer/ApproxProjectability.lean` | 167 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/BasisMeasurement.lean` | 78 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/BlockCollapse.lean` | 302 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/BornFibrePartition.lean` | 180 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/CircleFibre.lean` | 189 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/CircleRecord.lean` | 209 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/DegenerateLuders.lean` | 319 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/DeIsolationFlow.lean` | 131 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/DynamicBorn.lean` | 149 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/DynamicMeasurementClosure.lean` | 179 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/FibredSigma.lean` | 102 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/FibreRecord.lean` | 120 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/GlobalBasin.lean` | 241 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/GlobalRecordClosure.lean` | 187 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/HamiltonianSignature.lean` | 242 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/JoinArena.lean` | 349 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/JoinClosure.lean` | 153 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/JointFlowTransfer.lean` | 235 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/KSigmaRecord.lean` | 97 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/LocalBlockBridge.lean` | 172 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/LocalLuders.lean` | 165 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/LocalLudersBasis.lean` | 242 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/Measurement.lean` | 161 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/MeasurementProtocol.lean` | 271 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/MixedJoinLuders.lean` | 208 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/MixedLuders.lean` | 179 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/MixedSwap.lean` | 135 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/MomentMapRace.lean` | 129 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/NoRecordGeometry.lean` | 305 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/NullSeamLift.lean` | 213 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/NullSeamWitness.lean` | 827 | Pass with notes | S2 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/OnticComposite.lean` | 270 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/OnticMarginals.lean` | 354 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/OutcomeBasin.lean` | 118 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/OutcomeField.lean` | 132 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PhaseSlot.lean` | 332 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PiecewiseHamiltonian.lean` | 152 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerArena.lean` | 217 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerBorn.lean` | 258 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerCoupling.lean` | 242 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerFrequency.lean` | 115 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerHamiltonianField.lean` | 94 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerLanding.lean` | 248 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerLudersMarginal.lean` | 408 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerRotation.lean` | 273 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerSmoothProfile.lean` | 115 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/PointerWeights.lean` | 309 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/ProjectiveRecord.lean` | 135 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/RecordLayerClosure.lean` | 119 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/RecordPersistence.lean` | 163 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/RotatedContext.lean` | 121 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/RotatedSwap.lean` | 252 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/SharpenedNoGo.lean` | 164 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/ShearDiscontinuity.lean` | 222 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/ShearWitness.lean` | 449 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/SmoothProfile.lean` | 224 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/SwapClosure.lean` | 264 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
...
| `SigmaLayer/TorusFibre.lean` | 177 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
| `SigmaLayer/UnifiedArena.lean` | 340 | Pass with notes | S1 | Measurement/record/fibre support module; construction is formal and explicit, while apparatus calibration and witness-specific assumptions remain load-bearing. |
