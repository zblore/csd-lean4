...
| 5 | **Σ-fibre paper** | Born as ontic typicality volume at every `N`, but contextuality necessarily in the fibre for `N ≥ 3` — by covariance + non-negativity, **not** Gleason/KS | Yes | `specs/sigma-fibre-contextuality.md`; an honest-limitation result that narrows the programme |
