...
| **Lévy concentration / spherical isoperimetry** | Measure concentration on high-dimensional spheres | Canonical-typicality **concentration** (TH1 is expectation-level only) | Named residual, recorded; expectation form proved (`fs_first_moment`); the Chebyshev-grade route (BACKLOG Q24) avoids this gap entirely |
