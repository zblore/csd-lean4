...
| The Kähler triple, pointwise (`g`, `ω`, `J`); and closedness `dω = 0` of the Fubini–Study form on `ℂℙⁿ`, at manifold level, since 2026-09-07 | `fubiniStudy_pointwise_kahler_compatibility`, `fsForm_mextDeriv` | `Mathlib/Analysis/InnerProductSpace/KahlerForm`, `Mathlib/Geometry/Manifold/Instances/ProjectiveSpaceFubiniStudyForm` |
