...
| The Kähler triple, pointwise (`g`, `ω`, `J`); at manifold level `ℂℙⁿ` with the Fubini–Study form is a symplectic (2026-09-07) and Kähler (2026-09-10) manifold whose top power is `(4π)ⁿ μ_FS`; and the sector's Liouville measure IS that normalised top power, its unitary flows preserving it | `isFubiniStudyKahler`, `fsForm_isSymplectic`, `fsForm_isKahler`, `fsVolume_eq_smul_fubiniStudyMeasure`, `unitaryFlowSetup_isKahler_liouville` | `Mathlib/Analysis/InnerProductSpace/KahlerForm`, `Mathlib/Geometry/Manifold/Instances/ProjectiveSpaceFubiniStudySymplectic`, `LF4/SectorManifold` |
