...
public import CsdLean4.Tests.AxiomAudit.Witnesses
...
(CV+Thermo), `Incubator` (§H workstream staging; added 2026-08-07),
`Witnesses` (the concrete-witness suite; added 2026-08-12,
`specs/validation-hardening-plan.md`). This umbrella imports them all, so `lake build CsdLeanTests`
